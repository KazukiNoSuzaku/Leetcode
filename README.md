...
| 39 | [Combination Sum](https://leetcode.com/problems/combination-sum/) | [Python]() | 1. Choose the number 2. Explore further with the same number 3. Un-choose the number|
